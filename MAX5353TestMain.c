...
const uint16_t Wave[64] = {1024,1122,1219,1314,1407,1495,1580,1658,1731,1797,1855,1906,1948,1981,2005,2019,2024,2019,2005,1981,1948,1906,1855,1797,1731,1658,1580,1495,1407,1314,1219,1122,1024,926,829,734,641,553,468,390,317,251,193,142,100,67,43,29,24,29,43,67,100,142,193,251,317,390,468,553,641,734,829,926};
...
void PlayWave(void){
	...
	dacIndex = (dacIndex+1)&0x3F; // 0 to 63
	//dacIndex = (dacIndex+1)&0x1F;
...
int main(void){
  ...
  //SysTick_Init();
	...
	Timer0A_Init(&PlayWave, 1194);//64 C6
